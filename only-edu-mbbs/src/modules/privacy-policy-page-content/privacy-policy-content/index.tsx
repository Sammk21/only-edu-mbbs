  ...
  return (
    <section className="py-12 prose lg:max-w-[85%] lg:m-auto px-6 lg:px-0">
      ...
      <p className="text-accent">
        ...
        onlyeducation.in and how we use it.
      </p>
      <p className="text-accent">
        This Privacy Policy applies only to our online activities and is valid
        for visitors to our website with regards to the information that they
        shared and/or collect in onlyeducation.in. This policy is not applicable
      ...
      <p className="text-accent">
        Like any other website, onlyeducation.in uses 'cookies'. These cookies
      ...
      <p className="text-accent">
        ...
        advertising partners of onlyeducation.in.
      </p>{" "}
      <p className="text-accent">
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on onlyeducation.in, which are sent
      ...
      <p className="text-accent">
        onlyeducation.in's Privacy Policy does not apply to other advertisers or
