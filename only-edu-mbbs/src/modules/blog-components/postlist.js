      ...
      <div className="border-b border-b-borderLight dark:border-b-border mt-5">
        ...
        <div className="flex mt-3 gap-1 sm:gap-10 justify-between ">
          <Link href="#" className="sm:w-[70%] w-[70%]">
            ...
            >
              ...
              world’s leading travel and hospitality platforms. Serving millions
              of users globally, Booking.com offers various features and
              services that cater to diverse travel needs.
            </p>
          </Link>
          <Link
            href="#"
        ...
        <div className="sm:py-8 py-4 flex justify-between items-center ">
          ...
          >
            ...
            {/* <div className=" text-dark/60">6 min read</div> */}
          </Link>
